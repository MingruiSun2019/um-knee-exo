...
: ${AMENT_CURRENT_PREFIX:="/home/mingruis/um_knee_exo_ros2ws/install/test_utils"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/test_utils/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/test_utils/environment/path.sh"
